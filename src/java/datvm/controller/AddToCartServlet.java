...
public class AddToCartServlet extends HttpServlet {
    private final String MARKET_PLACE = "showBookProductServlet";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //3. Cust drop items into cart
            String item = request.getParameter("ddlBook");
            String quantity = request.getParameter("txtQuantity");
            int addItemQuantity = Integer.valueOf(quantity);
            cart.addItemToCart(item, addItemQuantity);
